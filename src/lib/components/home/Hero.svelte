...
<section class="relative min-h-[90vh] flex items-center pt-32 overflow-hidden">
  ...
  <div class="container mx-auto px-4 grid lg:grid-cols-2 gap-10 items-center">
    ...
    <div class="space-y-8 relative z-10">
      ...
      >
        Inspiring minds <br />
        to <GlitchText text="Code" class="text-primary" trigger="load" />,
        Innovate, <br />
        and <GlitchText text="Learn" class="text-primary" trigger="load" />
        every day
      </h1>
    ...
    <div class="relative lg:h-[600px] flex items-center justify-center">
      <div class="relative w-full max-w-lg aspect-square">
        <div
          class="absolute inset-0 from-primary/30 to-blue-500/30 rounded-full blur-[60px]"
        ></div>
        <img
          src={illustration}
          alt="Coding Club Illustration"
